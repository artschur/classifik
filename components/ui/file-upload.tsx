      ...
      >
        <div className="flex flex-col items-center justify-center">
          <p className="relative z-20 font-sans font-bold text-neutral-700 dark:text-neutral-300 text-base">
            Faça upload de suas imagens.
          </p>
          <p className="relative z-20 font-sans font-normal text-neutral-400 dark:text-neutral-400 text-base mt-2">
            Arraste ou clique aqui para enviar suas imagens.
          </p>
            ...
            <div className="w-full max-w-7xl mx-auto grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3">
              {files.map((file, idx) => (
                ...
                >
                  ...
                  <div className="flex pt-2 flex-col sm:flex-row text-sm items-start sm:items-center justify-between w-full mt-2 text-neutral-600 dark:text-neutral-400">
                    <motion.p
                      initial={{ opacity: 0 }}
                      animate={{ opacity: 1 }}
                      layout
